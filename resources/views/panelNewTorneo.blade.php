    ...
    <div class="row" style="margin-top: 20px; margin-left: 20px; margin-right: 20px">
        ...
        <div class="col-lg-9">
            ...
            @endif
                    ...
                    <form action="{!! route("panel.newTorneo") !!}" method="post">
                        ...
                        <input type="text" class="form-control" placeholder="Inicia" name="inicia">
                        <input type="text" class="form-control" placeholder="Termina" name="termina">
