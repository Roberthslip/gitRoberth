    ...
    <div class="row" style="margin-top: 20px; margin-left: 20px; margin-right: 20px">
        ...
        <div class="col-lg-9">
            ...
            @endif
                    ...
                    <form action="{!! route("panel.newJugador") !!}" method="post">
                        ...
                        <input type="text" class="form-control" placeholder="Avatar" name="numero">
                        <input type="text" class="form-control" placeholder="Goles" name="goles">
                        <input type="text" class="form-control" placeholder="Asistencias" name="asistencias">
